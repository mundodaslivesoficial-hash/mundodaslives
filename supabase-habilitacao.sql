...
drop policy if exists "habilitacoes_anon_insert" on habilitacoes;
...
drop policy if exists "habilitacoes_auth_read" on habilitacoes;
...
drop policy if exists "habilitacoes_auth_update" on habilitacoes;
